...
add_files "${KERNEL_ROOT}/${TOP_NAME}.cpp" -cflags "-I${KERNEL_ROOT} ${DEF_C_TEST}"
add_files "${KERNEL_ROOT}/binarySearch.cpp" -cflags "-I${KERNEL_ROOT} ${DEF_C_TEST}"

if {$EXPORT_XO_ONLY == 0} {
    add_files -tb "binarySearch_tb.cpp" -cflags "-I${KERNEL_ROOT} -D_C_TEST_"
}
